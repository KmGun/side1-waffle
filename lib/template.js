...
exports.makeMasterCalDB = async function(){
  let i = 0;
...
// 검증 필요
exports.createMasterCal = async function(req,res,data){
  fetch(`https://www.googleapis.com/calendar/v3/calendars?access_token=${req.user.mastertoken.access_token}`,{
    method: 'POST',
    headers: {
    // 'Host': 'oauth2.googleapis.com',
    'Content-Type': 'application/json'
    },
    body: JSON.stringify(req.body.summary),
  })
    .then(console.log)
}
